...
<div class="tp-offcanvas-area">
    <div class="tpoffcanvas">
        ...
        <div class="tpoffcanvas__logo offcanvas-logo">
            <a href="index.html">
                <img src="{{ asset('assets/media/logo.svg') }}" alt="Logo">
            </a>
        </div>
                ...
                <div class="canvas-bar-post-list">
                    <article class="post-block-style-wrapper post-block-template-two most-read-block-list">
                        <div class="post-block-style-inner post-block-list-style-inner">
                            <div class="post-block-media-wrap">
                                <a href="">
                                    <img src="{{ asset('assets/media/brown-fashion.jpg') }}" alt="Post title">
                                </a>
                            </div>
                    ...
                    <article class="post-block-style-wrapper post-block-template-two most-read-block-list">
                        <div class="post-block-style-inner post-block-list-style-inner">
                            <div class="post-block-media-wrap">
                                <a href="">
                                    <img src="{{ asset('assets/media/classic-dress.jpg') }}" alt="Post title">
                                </a>
                            </div>
                            <div class="post-block-content-wrap">
                                <div class="post-item-title">
                    ...
                    <article class="post-block-style-wrapper post-block-template-two most-read-block-list">
                        <div class="post-block-style-inner post-block-list-style-inner">
                            <div class="post-block-media-wrap">
                                <a href="">
                                    <img src="{{ asset('assets/media/sky-hat.jpg') }}" alt="Post title">
                                </a>
                            </div>
                            <div class="post-block-content-wrap">
                                <div class="post-item-title">
